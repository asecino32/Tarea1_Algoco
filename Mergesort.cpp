...
int main() {
    ...
    for (int i = 0; i < l1; i++) arr1[i] = rand() % l1;
    for (int i = 0; i < l2; i++) arr2[i] = rand() % l2;
    for (int i = 0; i < l3; i++) arr3[i] = rand() % l3;
    for (int i = 0; i < l4; i++) arr4[i] = rand() % l4;
    for (int i = 0; i < l5; i++) arr5[i] = rand() % l5;
    for (int i = 0; i < l6; i++) arr6[i] = rand() % l6; //para probar los tiempos de arr6, se debe probar 1 a 1
